...
public class MyAlertDialog extends AlertDialog implements DialogInterface {
    ...
    public static class Builder extends AlertDialog.Builder {
        ...
        /**
         * Constructor using a context for this builder and the {@link MyAlertDialog} it creates.
         */
        ...
        /**
         * Creates a {@link MyAlertDialog} with the arguments supplied to this builder. It does not
         * {@link Dialog#show()} the dialog. This allows the user to do any extra processing
         * before displaying the dialog. Use {@link #show()} if you don't have any other processing
         * to do and want this to be created and displayed.
         */
        public AlertDialog create() {
            final MyAlertDialog dialog = new MyAlertDialog(P.mContext);
        ...
        /**
         * Creates a {@link MyAlertDialog} with the arguments supplied to this builder and
